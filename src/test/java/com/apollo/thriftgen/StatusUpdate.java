...
public class StatusUpdate implements org.apache.thrift.TBase<StatusUpdate, StatusUpdate._Fields>, java.io.Serializable, Cloneable, Comparable<StatusUpdate> {
  ...
  private static final org.apache.thrift.protocol.TField SCHEDULER_FIELD_DESC = new org.apache.thrift.protocol.TField("scheduler", org.apache.thrift.protocol.TType.STRUCT, (short)4);

  private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
  static {
    schemes.put(StandardScheme.class, new StatusUpdateStandardSchemeFactory());
    schemes.put(TupleScheme.class, new StatusUpdateTupleSchemeFactory());
  }
  ...
  public SchedulerID scheduler; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.SCHEDULER, new org.apache.thrift.meta_data.FieldMetaData("scheduler", org.apache.thrift.TFieldRequirementType.OPTIONAL, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, SchedulerID.class)));
  ...
  public StatusUpdate(StatusUpdate other) {
    ...
    if (other.isSetScheduler()) {
      this.scheduler = new SchedulerID(other.scheduler);
    }
  }
  ...
  public StatusUpdate setTimestamp(long timestamp) {
    this.timestamp = timestamp;
    setTimestampIsSet(true);
    return this;
  }
   ...
   * @see TaskStatus
   */
  public StatusUpdate setStatus(TaskStatus status) {
    this.status = status;
    return this;
  }
  ...
  public StatusUpdate setMessage(String message) {
  ...
  public StatusUpdate setScheduler(SchedulerID scheduler) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SCHEDULER:
      if (value == null) {
        ...
        setScheduler((SchedulerID)value);
      }
      break;
  ...
  private static class StatusUpdateStandardSchemeFactory implements SchemeFactory {
    public StatusUpdateStandardScheme getScheme() {
      return new StatusUpdateStandardScheme();
    }
  }

  private static class StatusUpdateStandardScheme extends StandardScheme<StatusUpdate> {
        ...
        switch (schemeField.id) {
          ...
          case 4: // SCHEDULER
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.scheduler = new SchedulerID();
  ...
  private static class StatusUpdateTupleSchemeFactory implements SchemeFactory {
    public StatusUpdateTupleScheme getScheme() {
      return new StatusUpdateTupleScheme();
    }
  }

  private static class StatusUpdateTupleScheme extends TupleScheme<StatusUpdate> {
