              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.tasks = new ArrayList<com.apollo.thriftgen.TaskID>(_list0.size);
                  com.apollo.thriftgen.TaskID _elem1;
                  for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                  {
                    _elem1 = new com.apollo.thriftgen.TaskID();
                    _elem1.read(iprot);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, verifyTasks_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.tasks != null) {
          oprot.writeFieldBegin(TASKS_FIELD_DESC);
          {
            ...
            for (com.apollo.thriftgen.TaskID _iter3 : struct.tasks)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetTasks()) {
          {
            ...
            for (com.apollo.thriftgen.TaskID _iter4 : struct.tasks)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(1)) {
          {
            ...
            struct.tasks = new ArrayList<com.apollo.thriftgen.TaskID>(_list5.size);
            com.apollo.thriftgen.TaskID _elem6;
            for (int _i7 = 0; _i7 < _list5.size; ++_i7)
            {
              _elem6 = new com.apollo.thriftgen.TaskID();
              _elem6.read(iprot);
