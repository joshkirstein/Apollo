...
public class Resource extends org.apache.thrift.TUnion<Resource, Resource._Fields> {
  ...
  private static final org.apache.thrift.protocol.TField REQUESTED_PORT_FIELD_DESC = new org.apache.thrift.protocol.TField("requestedPort", org.apache.thrift.protocol.TType.STRING, (short)4);
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    REQUESTED_PORT((short)4, "requestedPort");
  ...
  static {
    ...
    tmpMap.put(_Fields.DISK_MB, new org.apache.thrift.meta_data.FieldMetaData("diskMb", org.apache.thrift.TFieldRequirementType.DEFAULT, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    tmpMap.put(_Fields.REQUESTED_PORT, new org.apache.thrift.meta_data.FieldMetaData("requestedPort", org.apache.thrift.TFieldRequirementType.DEFAULT, 
  ...
  public static Resource requestedPort(String value) {
    Resource x = new Resource();
    x.setRequestedPort(value);
    return x;
  }
  ...
  protected void checkType(_Fields setField, Object value) throws ClassCastException {
    switch (setField) {
      ...
      case REQUESTED_PORT:
        ...
        throw new ClassCastException("Was expecting value of type String for field 'requestedPort', but got " + value.getClass().getSimpleName());
      default:
  ...
  protected Object standardSchemeReadValue(org.apache.thrift.protocol.TProtocol iprot, org.apache.thrift.protocol.TField field) throws org.apache.thrift.TException {
    ...
    if (setField != null) {
      switch (setField) {
        ...
        case REQUESTED_PORT:
          if (field.type == REQUESTED_PORT_FIELD_DESC.type) {
            String requestedPort;
            requestedPort = iprot.readString();
  ...
  protected void standardSchemeWriteValue(org.apache.thrift.protocol.TProtocol oprot) throws org.apache.thrift.TException {
    switch (setField_) {
      ...
      case DISK_MB:
        ...
        return;
      case REQUESTED_PORT:
        String requestedPort = (String)value_;
        oprot.writeString(requestedPort);
        return;
      default:
  ...
  protected org.apache.thrift.protocol.TField getFieldDesc(_Fields setField) {
    switch (setField) {
      ...
      case REQUESTED_PORT:
        return REQUESTED_PORT_FIELD_DESC;
      default:
        throw new IllegalArgumentException("Unknown field id " + setField);
    }
  }
  ...
  public String getRequestedPort() {
    if (getSetField() == _Fields.REQUESTED_PORT) {
      return (String)getFieldValue();
    } else {
      throw new RuntimeException("Cannot get field 'requestedPort' because union is currently set to " + getFieldDesc(getSetField()).name);
    }
  }

  public void setRequestedPort(String value) {
    if (value == null) throw new NullPointerException();
    setField_ = _Fields.REQUESTED_PORT;
    value_ = value;
  }
  ...
  public boolean isSetRequestedPort() {
    return setField_ == _Fields.REQUESTED_PORT;
  }
